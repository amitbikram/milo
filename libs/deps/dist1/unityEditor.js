...
var ot = (a, t, e) => t in a ? lt(a, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[t] = e;
var o = (a, t, e) => (ot(a, typeof t != "symbol" ? t + "" : t, e), e);
class _ {
  static init() {
    return new _();
  }
    ...
    >
      <g id="Frame">
        <path
          id="iconPrimary"
          opacity="0.35"
          d="M9.8457 6.47363H3.45703V12.8623H9.8457V6.47363Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_2"
          opacity="0.35"
          d="M16.2363 19.251H15.1301L9.84766 14.4595V12.8623H16.2363V19.251Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_3"
          opacity="0.35"
          d="M22.623 6.47363H16.2344V12.8623H22.623V6.47363Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_4"
          opacity="0.35"
          d="M29.0137 12.8623H22.625V19.251H29.0137V12.8623Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_5"
          opacity="0.35"
          d="M22.623 19.7054L16.2344 21.5828V19.251H22.623V19.7054Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_6"
          d="M23.4204 12.095C23.4204 13.4181 22.3478 14.4907 21.0247 14.4907C19.7015 14.4907 18.6289 13.4181 18.6289 12.095C18.6289 10.7718 19.7015 9.69922 21.0247 9.69922C22.3478 9.69922 23.4204 10.7718 23.4204 12.095Z"
          fill="#292929"
        />
        <path
          id="iconPrimary_7"
          d="M27.0148 4.87598H5.453C3.47136 4.87598 1.85938 6.48875 1.85938 8.4696V23.6427C1.85938 25.6235 3.47136 27.2363 5.453 27.2363H27.0148C28.9964 27.2363 30.6084 25.6235 30.6084 23.6427V8.4696C30.6084 6.48875 28.9964 4.87598 27.0148 4.87598ZM5.453 7.27173H27.0148C27.6753 7.27173 28.2126 7.80983 28.2126 8.4696V21.5834L25.1641 18.5346C23.8072 17.1776 21.4372 17.1776 20.0817 18.5346L18.1141 20.5014C17.959 20.6574 17.7039 20.6558 17.5488 20.5029L12.3868 15.3402C11.0298 13.9833 8.65983 13.9833 7.30442 15.3402L4.25514 18.3895V8.4696C4.25514 7.80983 4.79246 7.27173 5.453 7.27173ZM5.453 24.8406C4.79246 24.8406 4.25513 24.3025 4.25513 23.6427V21.7773L8.99905 17.0341C9.44982 16.5818 10.2398 16.5818 10.6921 17.0341L15.8556 22.1984C16.9443 23.284 18.717 23.2886 19.8072 22.1968L21.7764 20.2284C22.2272 19.7761 23.0172 19.7761 23.4695 20.2284L27.783 24.5419C27.5736 24.7208 27.311 24.8406 27.0147 24.8406L5.453 24.8406Z"
          fill="#292929"
        />
      </g>
    </svg>
  </button>
  <button class="unity-bg">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
      height="17"
      viewBox="0 0 40 35.447"
    >
      <g id="Icon" transform="translate(-7 -8.999)">
        <circle
          id="Ellipse_3"
          data-name="Ellipse 3"
          cx="2.778"
          cy="2.778"
          r="2.778"
          transform="translate(30.667 15.779)"
          fill="#000"
        />
        <path
          id="Path_2725"
          data-name="Path 2725"
          d="M16.333,27.557a13.585,13.585,0,0,1,1.4-6c-2.342-2.62-4.783-6.222-6.863-6.222-2.969,0-8.65,8.889-8.65,8.889v-20H37.778v12.1A13.74,13.74,0,0,1,40,18.263V3.112A1.187,1.187,0,0,0,38.75,2H1.25A1.187,1.187,0,0,0,0,3.112V32a1.187,1.187,0,0,0,1.25,1.111H17.521a13.6,13.6,0,0,1-1.188-5.556Z"
        ...
        <path
          id="Path_2726"
          data-name="Path 2726"
          d="M18.939,9.05a9.889,9.889,0,1,0,9.889,9.889A9.889,9.889,0,0,0,18.939,9.05Zm5.556,10.444a.556.556,0,0,1-.556.556H20.05v3.889a.556.556,0,0,1-.556.556H18.383a.556.556,0,0,1-.556-.556V20.05H13.939a.556.556,0,0,1-.556-.556V18.383a.556.556,0,0,1,.556-.556h3.889V13.939a.556.556,0,0,1,.556-.556h1.111a.556.556,0,0,1,.556.556v3.889h3.889a.556.556,0,0,1,.556.556Z"
          transform="translate(18.061 15.618)"
          fill="#000"
        />
      </g>
    </svg>
...
class X {
  constructor(t, e) {
    this.canvas = t, this.configuration = e, this.onModeChanged = new q(), this.onLayerOrderChanged = new q(), this.onPropertiesChanged = new q();
  }
  add(t) {
...
class c {
  static createSvg(t, e) {
    const i = document.createElementNS(K, "svg");
    i.setAttribute("viewBox", "0 -960 960 960"), i.setAttribute("height", "18"), i.classList.add(e);
    const s = document.createElementNS(K, "path");
    return s.setAttribute("d", t), i.appendChild(s), i;
  }
}
o(c, "cursor", "m320-410 79-110h170L320-716v306ZM551-80 406-392 240-160v-720l560 440H516l144 309-109 51ZM399-520Z"), o(c, "rect", "M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0 0v-560 560Z"), o(c, "eye", "M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"), o(c, "eyeOff", "m644-428-58-58q9-47-27-88t-93-32l-58-58q17-8 34.5-12t37.5-4q75 0 127.5 52.5T660-500q0 20-4 37.5T644-428Zm128 126-58-56q38-29 67.5-63.5T832-500q-50-101-143.5-160.5T480-720q-29 0-57 4t-55 12l-62-62q41-17 84-25.5t90-8.5q151 0 269 83.5T920-500q-23 59-60.5 109.5T772-302Zm20 246L624-222q-35 11-70.5 16.5T480-200q-151 0-269-83.5T40-500q21-53 53-98.5t73-81.5L56-792l56-56 736 736-56 56ZM222-624q-29 26-53 57t-41 67q50 101 143.5 160.5T480-280q20 0 39-2.5t39-5.5l-36-38q-11 3-21 4.5t-21 1.5q-75 0-127.5-52.5T300-500q0-11 1.5-21t4.5-21l-84-82Zm319 93Zm-151 75Z"), o(c, "locked", "M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"), o(c, "close", "m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"), o(c, "text", "M420-160v-520H200v-120h560v120H540v520H420Z"), o(c, "image", "M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm40-80h480L570-480 450-320l-90-120-120 160Zm-40 80v-560 560Z"), o(c, "brush", "M240-120q-45 0-89-22t-71-58q26 0 53-20.5t27-59.5q0-50 35-85t85-35q50 0 85 35t35 85q0 66-47 113t-113 47Zm0-80q33 0 56.5-23.5T320-280q0-17-11.5-28.5T280-320q-17 0-28.5 11.5T240-280q0 23-5.5 42T220-202q5 2 10 2h10Zm230-160L360-470l358-358q11-11 27.5-11.5T774-828l54 54q12 12 12 28t-12 28L470-360Zm-190 80Z"), o(c, "erase", "M690-240h190v80H610l80-80Zm-500 80-85-85q-23-23-23.5-57t22.5-58l440-456q23-24 56.5-24t56.5 23l199 199q23 23 23 57t-23 57L520-160H190Zm296-80 314-322-198-198-442 456 64 64h262Zm-6-240Z"), o(c, "arrowUp", "M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z"), o(c, "arrowDown", "M440-800v487L216-537l-56 57 320 320 320-320-56-57-224 224v-487h-80Z"), o(c, "menu", "M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z");
function Z(a, t, e) {
  const i = new q(), s = w.element("span", {
    class: `icon-button icon-button-${e}`,
    title: t
  }), n = c.createSvg(a, "icon-button-icon"), l = n.querySelector("path");
  return s.appendChild(n), s.addEventListener(
    "click",
    (d) => {
      d.preventDefault(), d.stopPropagation(), i.forward();
    },
    !1
  ), {
    view: s,
...
class I {
  ...
  static create(t, e, i, s) {
    ...
    const l = Z(Y(e), "Toggle visibility", "sm"), d = Z(c.close, "Delete layer", "sm");
    let r, v;
    const E = w.div({
    ...
    b.innerHTML = e.get("label") ?? e.type, E.appendChild(b), n.appendChild(l.view), n.appendChild(E), r = Z(c.arrowUp, "Move layer up", "sm"), n.appendChild(r.view), v = Z(c.arrowDown, "Move layer down", "sm"), n.appendChild(v.view), n.appendChild(d.view);
    const f = new I(n, t, e, b, l);
    return n.addEventListener("click", f.onItemClicked, !1), b.addEventListener("input", f.onLabelChanged, !1), l.onClicked.subscribe(f.onVisibilityClicked), r == null || r.onClicked.subscribe(f.onMoveUpClicked), v == null || v.onClicked.subscribe(f.onMoveDownClicked), d.onClicked.subscribe(f.onDeleteClicked), f;
  }
  setIsSelected(t) {
...
class N {
  constructor(t, e, i) {
    o(this, "reloadList", () => {
      ...
      this.state.forEachObject((t, e, i) => {
        const s = e === 0, n = I.create(this.state, t, s, i);
  ...
  static create(t) {
    ...
    const i = vt("Layers", e), s = new N(i.view, t, e);
...
class Tt {
  constructor(t, e = {}) {
    ...
    this.element = t, this.container = this.checkMountType(t), this.canvasLoaded = !1, this.canvas = null, this.config = { ...gt, ...e }, this.onChanged = new q(), this.height = this.container.clientHeight, this.width = this.container.clientWidth, this.$ = (i) => this.container.querySelector(i), this.filters = null, this.loadEditor();
  }
  async loadEditor() {
    this.config.editorMode === "standalone" ? (this.fabric = await import("./fabric-T-x1IxqJ.js").then((t) => t.f), this.filters = _.init(), this.loadRightMenu(), this.bindFilterEvents(), this.loadControls(), this.loadCanvas(), this.bindEvents(), this.state = new X(this.canvas, this.config), this.initLayerPanel()) : (this.loadControls(), this.bindEvents());
  }
  checkMountType(t) {
    if (t.tagName === "IMG") {
      const e = t.clientHeight, i = t.clientWidth, s = document.createElement("div");
      return s.style.height = `${e}px`, s.style.width = `${i}px`, W(t) && (s.style.position = "relative"), t.parentNode.insertBefore(s, t), s.appendChild(t), s;
    } else if (t.tagName === "PICTURE") {
      const e = t.querySelector("img"), i = e.clientHeight, s = e.clientWidth, n = document.createElement("div");
      return n.style.height = `${i}px`, n.style.width = `${s}px`, W(t) && (n.style.position = "relative"), t.parentNode.insertBefore(n, t), n.appendChild(t), n;
    } else
      return W(t) && (t.style.position = "relative"), t;
  }
  loadRightMenu() {
    const t = document.createElement("div");
    t.classList.add("menu-right"), t.classList.add("sliderTray"), this.container.appendChild(t), this.$(".sliderTray").insertAdjacentHTML("beforeend", dt), this.$(".sliderTray").insertAdjacentHTML("beforeend", ct);
  }
  loadControls() {
    this.container.insertAdjacentHTML("beforeend", rt);
  }
  loadCanvas() {
    const t = document.createElement("div");
  ...
  bindEvents() {
    this.$("#import-btn").addEventListener("change", async (t) => {
      this.canvasLoaded || (this.fabric = await import("./fabric-T-x1IxqJ.js").then((i) => i.f), this.filters = _.init(), this.loadRightMenu(), this.bindFilterEvents(), this.loadCanvas(), this.state = new X(this.canvas, this.config), this.initLayerPanel());
      const e = t.target.files[0];
      if (e) {
        const i = new FileReader();
        i.onload = (s) => {
          const n = s.target.result;
          fabric.Image.fromURL(n, (l) => {
            const d = {
              width: l.width,
              height: l.height,
              selectable: !1
            }, r = Math.min(this.width / l.width, this.height / l.height);
            d.left = (this.width - l.width * r) / 2, d.top = (this.height - l.height * r) / 2, d.scaleX = r, d.scaleY = r, l.set(d), this.canvas.add(l);
          });
        }, i.readAsDataURL(e);
      }
    });
...
class qt {
  checkMountType(t) {
    if (t.tagName === "IMG") {
      ...
      const e = U(t);
      return t.classList.add("editor-wrapper"), e && (t.style.position = "relative"), t;
    }
  }
  constructor(t, e = {}) {
    this.element = t, this.src = null, this.editorWrapper = this.checkMountType(t), this.height = this.editorWrapper.clientHeight, this.width = this.editorWrapper.clientWidth, this.config = { ...wt, ...e, dimensions: [this.width, this.height] }, this.editorWrapper.insertAdjacentHTML("beforeend", ut), this.config.editorMode === "standalone" && this.bindEvents();
  }
  bindEvents() {
    window.addEventListener("keydown", (t) => this.onKeyDownHandler(t)), this.editorWrapper.querySelector("#import-btn").addEventListener("change", (t) => {
      ...
      if (e && e.type === "image/svg+xml") {
        ...
        i.onload = (s) => {
          ...
          const l = this.editorWrapper, d = getComputedStyle(l, null).height.replace("px", ""), r = getComputedStyle(l, null).width.replace("px", "");
          this.canvas.setCurrentZoom(d / this.canvas.contentH), this.canvas.updateCanvas(r, d);
        }, i.readAsText(e);
      } else
      ...
      }), this.canvas.setMode("select"), ft(this.hiddenTextTag, "keyup input", (e) => {
...
<div class="upload-btn-wrapper">
  ...
  let n = /\..*$/, l = String(s).match(n);
  return e + ":" + i + ":" + String(s).replace(n, "") + (t ? l ? l[0] : ".000" : "");
}, A = async (a) => new Promise((t, e) => {
  const i = new FileReader();
  i.onload = () => {
    t(i.result);
...
function yt({
  ...
  if (a.length === 0 && !n)
    return null;
  if (n) {
    const C = x("h2", {}, "Processing thumbnails.....");
    return x("center", {}, C);
  }
  const r = document.getElementById("rangePack");
  r.innerHTML = "";
  const v = x("div", { class: "image_box" });
  a.forEach((C, H) => {
    const $ = x("img", {
      src: C,
      alt: `sample_video_thumbnail_${H}`
    });
    v.appendChild($);
  });
  const E = x("div", {
  ...
  for (let C = 0; C < 2; C++) {
    const H = x("span", { class: "clip_box_des" });
    E.appendChild(H);
  }
  v.appendChild(E);
  const b = x("input", {
  ...
  v.appendChild(b), v.appendChild(f), r.appendChild(v);
}
...
async function Lt() {
  await J("/libs/deps/dist/assets/ffmpeg/package/dist/umd/ffmpeg.js"), await J("/libs/deps/dist/assets/util/package/dist/umd/index.js"), j = FFmpegUtil.fetchFile, tt = FFmpegWASM.FFmpeg, u = new tt(), u.on("log", ({ message: a }) => {
    console.log(a);
  }), u.on("progress", ({ progress: a }) => {
    console.log(`${a * 100} %`);
  }), await u.load({
    coreURL: "/libs/deps/dist/assets/core/package/dist/umd/ffmpeg-core.js"
  });
}
async function Mt(a, t) {
  t = { ...xt, ...t };
  const e = a.clientHeight, i = a.clientWidth, s = document.createElement("div");
  s.style.height = `${e}px`, s.style.width = `${i}px`, s.classList.add("editor-wrapper"), mt(a) && (s.style.position = "relative"), a.parentNode.insertBefore(s, a), s.appendChild(a);
  const [l, d] = L(null), [r, v] = L({}), [E, b] = L([]), [f, C] = L(!1), [H, $] = L(null), [St, D] = L(!1), [T, et] = L(0), [k, it] = L(10);
  a.insertAdjacentHTML("afterend", Ct), document.querySelector("#import-btn").addEventListener("change", st), a.addEventListener("loadedmetadata", at);
  async function st({ target: { files: h } }) {
    const p = h[0];
    a.src = await A(p), v(p), b(await A(p));
  }
  document.querySelector(".video-trim").addEventListener("click", () => G()), document.querySelector(".video-frames").addEventListener("click", async () => {
    const h = a.querySelector("source").src, p = await bt(h), g = "input.mp4";
    await u.writeFile(g, await j(p));
    const y = await u.readFile(g);
    v(y), z(a);
  });
  async function G() {
    D(!0);
    let h = (T() / 100 * l().duration).toFixed(2), p = (k() / 100 * l().duration - h).toFixed(2);
    console.log(
      h,
      p,
      m(h),
    ...
    try {
      ...
      const g = await u.readFile("ping.mp4"), y = await A(
        new Blob([g.buffer], { type: "video/mp4" })
      );
      document.querySelector("video").src = y, $(y);
    } catch (g) {
      console.log(g);
    } finally {
      D(!1);
  ...
  async function at(h) {
    const p = h.target;
    s.style.width = `${p.videoWidth}px`, s.style.height = `${p.videoHeight}px`, z(p);
  }
  async function z(h) {
    const p = (P) => (R) => {
      P(R.target.value);
      const O = document.querySelector(".clip_box");
      O.style = `width: calc(${k() - T()}%); left: ${T()}%;`, O.dataset.start = m(
        `${T() / Q * S.duration}`,
        !1
      ), O.dataset.end = m(
        `${k() / Q * S.duration}`,
    ...
    d(g);
    const y = await nt(g), V = p(et), M = p(it), B = !1, S = { duration: 60 };
    yt({
      thumbNails: y,
      rEnd: k(),
      rStart: T(),
      handleUpdaterStart: V,
      handleUpdaterEnd: M,
      loading: B,
      videoMeta: S,
      handleTrim: G
  ...
  const nt = async ({ duration: h }) => {
    C(!0);
    let p = 15, g = h < p ? h : 15, y = h === p ? 1 : h / g;
    const V = [];
    await u.writeFile(
      r().name,
      await j(r())
    ...
    for (let M = 0; M < g; M++) {
      ...
      try {
        ...
        const S = await u.readFile(`img${M}.png`);
        let P = new Blob([S.buffer], { type: "image/png" }), R = await A(P);
        V.push(R);
      } catch (S) {
